...
```haskell
import Servant.Auth.Roles (CheckRole(..))
...
```haskell
import Servant.Auth.Roles (HasRole(..))
...
import Servant.Auth.Roles (HasRole(..), RequireRole, CheckRole(..), Proxy(..))
